...
import UserCommentWithImage from "../../Molecules/UserCommentWithImage/UserCommentWithImage";
...
import styles from "./ViewAndAddPostComment.module.css";
		...
		<Paper elevation={1} className={styles.container}>
			<CircleImageWithTextInput
				...
				onImageClickDestination={
					props.authenticatedUser.authenticatedProfileImage
				}
				isOnline={true}
			/>
			{arrayOfUserComments}
